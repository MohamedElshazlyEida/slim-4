...
## Documentation Sections
 ...
 - [Migrate & Seed Database](https://github.com/MohamedElshazlyEida/slim-4#migrate-and-seed-database)
 - [Register Middleware](https://github.com/MohamedElshazlyEida/slim-4#register-middleware)
 - [Register Console Commands](https://github.com/MohamedElshazlyEida/slim-4#create-and-register-new-php-slim-command)
 - [php slim make:{scaffold} generators](https://github.com/MohamedElshazlyEida/slim-4#php-slim-makecommand-scaffold-stub-generators)
...
- [Global Helper Functions](https://github.com/MohamedElshazlyEida/slim-4#global-helper-functions)
- [Validators](https://github.com/MohamedElshazlyEida/slim-4#validatorinput-rules---messages--)
- [Mailables](https://github.com/MohamedElshazlyEida/slim-4/blob/master/README.md#mailables-send-emails)
- [Events And Listeners](https://github.com/MohamedElshazlyEida/slim-4/blob/master/README.md#events-events--associated-listeners-with-dependency-injection)
- [Packages & Resources Glossary](https://github.com/MohamedElshazlyEida/slim-4#packages--resources-glossary)
...
```
git clone https://github.com/MohamedElshazlyEida/slim-4.git
...
3. Open `slim-4/homestead.yaml` and update folders map path (Has comment next to it below)
```
ip: 192.168.10.10
memory: 2048
cpus: 2
...
folders:
    -
       # Replace `map: /Users/zhorton/tutorials/slim-4`
       # With `map: {the_copied_output_from_pwd_in_step_2}
        map: /Users/zhorton/tutorials/slim-4
...
13. `cd` back into `slim-4` within your terminal
...
2. Open `slim-4/app/Http/HttpKernel`
